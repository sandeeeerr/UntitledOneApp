    ...
    <section id='intro' className='mb-36 pb-20 min-h-[60vh] '>
      ...
      <div className=' gap-y-2 my-4 grid items-start lg:grid-cols-3'>
        <div>
          ...
          <p className='text-gray-400'>Ensure a uniform visual and interactive experience across all platforms, maintaining reliable user interfaces at every touchpoint.</p>
        </div>
        <div>
          <Icons.timerReset className='h-24 w-24 my-8 text-danger' />
          <h3 className='text-xl font-medium mb-3'>Efficiency</h3>
          <p className='text-gray-400'>Streamline workflow for designers and developers by providing a centralized repository of standardized design elements and practices.</p>
        </div>
        <div>
          <Icons.scaling className='h-24 w-24 my-8 text-amber-400' />
          <h3 className='text-xl font-medium mb-3'>Scalability</h3>
          <p className='text-gray-400'>Facilitate effortless expansion and diversification, enabling the integration of new features while preserving brand and user experience quality.</p>
        </div>
      </div>
      ...
      <h4>faq</h4>
      <p className='mb-5 font-small text-gray-500 dark:text-gray-400'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>

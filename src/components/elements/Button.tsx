  ...
  "active:scale-95 inline-flex items-center justify-center rounded-md text-sm font-medium transition-colors disabled:opacity-50  disabled:pointer-events-none ",
  {
    variants: {
      variant: {
        ...
        secondary: "bg-darkGrey text-lightGrey hover:bg-transparent",
        disabled: "bg-darkGrey text-lightGrey opacity-50",
        ghost: "bg-transparent text-lightGrey hover:bg-darkGrey",

  ...
  return (
    <div className='relative transition-all rounded-md bg-Grey hover:scale-105 hover:border-blue-gray-100 hover:bg-blue-gray-50 hover:bg-opacity-25' >
      ...
      <div className='absolute bottom-0 z-10 p-3 sm:p-5'>
        ...
        <div className=''>
          <div className='text-xs text-lightGrey text'>
            <span className=''>By: u/{project.author.username}</span>
            <span className='hidden sm:inline'><br />Last updated: {formatTimeToNow(new Date(project.createdAt))}</span>

    ...
    <>
      ...
      <ShowcaseBlock gridCols="3">
        <div className="items-center justify-center flex">
          <a
            href="#"
            className="duration-100 hover:scale-110 bg-secondary text-black  py-2 px-5 rounded "
          >
            Hover!
          </a>
        </div>
        <div className="items-center justify-center flex">
          <a
            href="#"
            className="duration-200 hover:scale-110 bg-secondary text-black  py-2 px-5 rounded "
          >
            Hover!
          </a>
        </div>
        <div className="items-center justify-center flex">
          <a
            href="#"
            className="duration-300 hover:scale-110 bg-secondary text-black  py-2 px-5 rounded "
          >
            Hover!
          </a>
        </div>

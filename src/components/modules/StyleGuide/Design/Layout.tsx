...
function Layout() {
  return (
    <>
      ...
      <ShowcaseBlock>
        <div className="flex space-x-3 ">
          <div className="w-full border-2 rounded bg-darkGrey pt-28 "></div>
        </div>
      </ShowcaseBlock>
      ...
      <ShowcaseBlock>
        <div className="flex space-x-3 ">
          <div className="w-1/4 border-2 rounded bg-darkGrey pt-28"></div>
          <div className="w-3/4 border-2 rounded bg-background pt-28 "></div>
        </div>
      </ShowcaseBlock>
      ...
      <ShowcaseBlock>
        <div className="flex space-x-3 ">
          <div className="w-3/4 border-2 rounded bg-background pt-28 "></div>
          <div className="w-1/4 border-2 rounded bg-backgroundOverlays pt-28"></div>
        </div>
      </ShowcaseBlock>

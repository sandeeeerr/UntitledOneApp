...
function ColorScheme() {
  return (
    <>
      <h4>Brand colors</h4>
      <p className='mb-5 text-gray-400 font-small'>Utilizing a vibrant, trustworthy blue as our primary and a lively, positive green as our secondary, our brand colors not only enhance user engagement and trust but also provide a coherent and visually appealing interface across all platforms and materials, seamlessly blending reliability with vibrancy.</p>
      ...
      <h4>Greyscales</h4>
      <p className='mb-5 text-gray-400 font-small'>Our grayscale palette, ranging from deep black to light grey, encompasses five nuanced shades meticulously chosen to provide depth, contrast, and readability across all design elements</p>
      ...
      <h4>UI Colors</h4>
      <p className='mb-5 text-gray-400 font-small'>Utilizing our brand's blue and green for general UI, and incorporating a notable red for danger and a vivid yellow for warnings, we ensure our interface is not only visually cohesive but also effectively communicative regarding alerts and user guidance.</p>

  ...
  return (
    <>
      ...
      <p className="mb-5 font-small text-gray-400">
        The font scale consists of 5 different font sizes. The default size
        applied to the body is Medium.
      </p>
      ...
      <ShowcaseBlock>
        <div className={` w-full text-left rounded-lg`}>
          <p className="text-gray-600">
            Page-headers{" "}
            <span className="float-right font-normal text-gray-500">
              Black 64px 72 Line height #31a0f0
            </span>
          </p>
          <h1>INTER H1</h1>
          <p className="text-gray-600">
...
<h5>Inter H5</h5>`}
      ...
      <h4>Font weight</h4>
      <p className="mb-5 font-small text-gray-400">
        There are two font weights available to use — Bold and Regular.
      </p>

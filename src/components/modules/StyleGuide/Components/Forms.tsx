      ...
      <div className="flex items-center justify-center w-full">
        <Label className="flex flex-col items-center justify-center w-full h-32 border-2 border-lightGrey border-dashed rounded cursor-pointer bg-backgroundSecondary">
            <div className="flex flex-col items-center justify-center pt-5 pb-6">
                <svg className="w-8 h-8 mb-4 text-lightGrey" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 16">
                ...
                <p className="mb-2 text-sm text-lightGrey">Drag & drop or <span className="text-secondary">Choose file</span> to upload </p>
                <p className="text-xs text-lightGrey">FLAC, MP3, WAV or AAC (MAX. 100 MB)</p>
            </div>

    ...
    <>
      <nav className="fixed top-0 z-10 w-full bg-black border-y-2 border-t-transparent">
                ...
                <>
                  ...
                  <li className="list-none">
                    <button
                      ...
                      className="flex items-center justify-between w-full ml-1 "
                    >
                    ...
                    <div
                      id="dropdownNavbar"
                      className="z-10 hidden px-1 my-5 text-base text-center list-none bg-black border rounded shadow w-44"
                    >
                      <ul
        ...
        <div className="hidden h-screen px-20 pt-10 border-t mobile-menu ">
          <a
            href="#"
            className="block px-4 py-4 text-center border-b border-neutral-800"
          >
            Home
          </a>
          <a
